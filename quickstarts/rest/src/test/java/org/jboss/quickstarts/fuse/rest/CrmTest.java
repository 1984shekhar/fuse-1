...
public final class CrmTest {
    ...
    public static final String SERVER_BASE_URL = System.getProperty("fuse-server", "http://localhost:8181");

    public static final String CUSTOMER_TEST_URL = SERVER_BASE_URL+"/cxf/crm/customerservice/customers/123";
    public static final String PRODUCT_ORDER_TEST_URL = SERVER_BASE_URL+"/cxf/crm/customerservice/orders/223/products/323";
    public static final String CUSTOMER_SERVICE_URL = SERVER_BASE_URL+"/cxf/crm/customerservice/customers";
